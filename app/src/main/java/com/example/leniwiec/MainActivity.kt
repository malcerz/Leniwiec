...
import com.example.leniwiec.theme.LeniwiecTheme
...
class WebAppInterface(
  ...
  fun calculateRouteAsync(lonlats: String, profile: String, alternativeIdx: Int, nogoLonLats: String, callbackId: Int) {
    ...
    activity.lifecycleScope.launch {
      val resultJson = routeService.calculateRoute(lonlats, profile, alternativeIdx, nogoLonLats) { linksProcessed, elapsedMs ->
        activity.runOnUiThread {
